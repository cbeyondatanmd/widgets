(function() { 
	...
	class Gauges extends HTMLElement {
		constructor() {
			super(); 
		...
		polar_to_cartesian(cx, cy, radius, angle) {
		    var radians;
		    radians = (angle - 180) * Math.PI / 360.0;
