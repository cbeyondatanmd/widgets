(function () {
    ...
    tmpl.innerHTML = `
        <style>
        com-cbeyondata-datepicker-aps * {
            box-sizing: border-box;
        }
        com-cbeyondata-datepicker-aps > p {
            margin: 16px 0 4px 0;
            line-height: 22px;
            font-size: 0.875rem;
            color: #999999;
        }
        com-cbeyondata-datepicker-aps > p:first-of-type {
            margin-top: 0;
        }
        com-cbeyondata-datepicker-aps > label {
            color: #333333 !important;
            font-size: 0.875rem;
        }
        com-cbeyondata-datepicker-aps select {
            border: 1px solid rgb(191, 191, 191);
            padding: 3px 5px;
            width: calc(100% + 20px);
        }
        com-cbeyondata-datepicker-aps select:hover,
        com-cbeyondata-datepicker-aps select:focus {
            border: 1px solid #346187;
            cursor: pointer;
        }
        com-cbeyondata-datepicker-aps > div.select {
            position: relative;
            overflow: hidden;
        }
        com-cbeyondata-datepicker-aps > div.select::after {
            content: "\ue7ac";
        ...
        com-cbeyondata-datepicker-aps > div.select:focus-within::after,
        com-cbeyondata-datepicker-aps > div.select:hover::after {
            background-color: rgba(179, 179, 179, 0.5);
            border: 1px solid #346187;
            border-left-color: transparent;
        }
        com-cbeyondata-datepicker-aps .checkbox {
            position: relative;
            display: flex;
            align-items: center;
            height: 22px;
        }
        com-cbeyondata-datepicker-aps .checkbox input {
            position: absolute;
            opacity: 0;
            cursor: pointer;
            height: 0;
        ...
        com-cbeyondata-datepicker-aps .checkbox div.checkmark {
            position: relative;
            height: 16px;
            width: 16px;
        ...
        com-cbeyondata-datepicker-aps .checkbox div.checkmark:hover {
            cursor: pointer;
            border-color: #427cac;
        }
        com-cbeyondata-datepicker-aps .checkbox input:checked ~ div.checkmark:after {
            content: "\ue614";
            font-family: "fpa-icons";
            color: #427cac;
            position: absolute;
        ...
        com-cbeyondata-datepicker-aps .checkbox input:focus ~ div.checkmark {
            outline: 1px dotted #333;
        }
        com-cbeyondata-datepicker-aps p.info {
    ...
    customElements.define('com-cbeyondata-datepicker-aps', DatePickerAps);
})();